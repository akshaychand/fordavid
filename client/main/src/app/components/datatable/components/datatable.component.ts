...
export class DataTableComponent<T extends fromModels.IEntity> implements OnInit {
    ...
    @Input() options: fromModels.IDataTableOptions;

    private defaultOptions:  fromModels.IDataTableOptions = {
    ...
    get gridOptions(): fromModels.IDataTableOptions {
        return Object.assign({}, this.options, this.defaultOptions);
    }

    get allowExport(): boolean {
        return this.gridOptions.allowExport;
    }

    get exportFileName(): string {
        return this.gridOptions.exportFileName;
    }
